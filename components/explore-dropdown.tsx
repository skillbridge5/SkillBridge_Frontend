          ...
          <div className="bg-white rounded-lg shadow-lg border overflow-hidden flex flex-col sm:flex-row max-w-[80vw] sm:max-w-[80vw] md:max-w-[720px] lg:max-w-[900px]">
            ...
            <div className="w-[172px] sm:w-[250px] md:w-[300px] max-h-[60vh] sm:max-h-[80vh] overflow-y-auto">
              ...
              <div className="p-3 sm:px-4 border-b">
                <h3 className="text-gray-800 text-xs sm:text-sm">Certification preparation</h3>
              </div>
              ...
              <div className="w-full sm:w-[250px] md:w-[300px] max-h-[60vh] sm:max-h-[80vh] overflow-y-auto border-t sm:border-t-0 sm:border-l">
                ...
                {categoriesData
                  ...
                  ?.subcategories.map((subcategory, index) => (
                    <div
                      key={index}
                      className={`flex items-center justify-between px-3 py-2 sm:px-4 sm:py-3 hover:bg-gray-100 cursor-pointer transition-colors duration-150 ${
            ...
            {activeSubcategory && (
              <div className="w-full sm:w-[250px] md:w-[300px] max-h-[60vh] sm:max-h-[80vh] overflow-y-auto border-t sm:border-t-0 sm:border-l">
                ...
                <div className="px-3 py-2 sm:px-4 sm:py-3 border-b">
                  <h3 className="text-gray-800 text-xs sm:text-sm">Popular topics</h3>
                </div>
                {categoriesData
                  .find((cat) => cat.name === activeCategory)

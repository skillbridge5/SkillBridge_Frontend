...
import { Star, Clock, Award, Users, BookOpen, CheckCircle, AlertCircle } from "lucide-react"
...
export default function CourseDetailPage() {
            ...
            <TabsContent value="about" className="pt-6">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-4">{course.longDescription || course.description}</p>
                </div>
            ...
            <TabsContent value="instructor" className="pt-6">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 mb-4">{course.instructorTitle || "Course Instructor"}</p>
              ...
              <div className="p-6">
                <div className="flex items-baseline gap-2 mb-4">
                  ...
                  <Badge className="ml-auto bg-green-500">
                    {Math.round((1 - course.discount / course.price) * 100)}% off
                  </Badge>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <RadioGroup defaultValue="one-time">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="one-time">One-time payment (${course.discount})</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="monthly" id="monthly" />
                      <Label htmlFor="monthly">
                        Monthly subscription (${Math.round(course.discount / 3)}/month for 3 months)
                      </Label>
                    </div>
                  </RadioGroup>
                </div>

                <Button className="w-full mb-4" size="lg" onClick={() => setIsEnrollDialogOpen(true)}>
                  Enroll Now
                </Button>
  ...
  <DialogContent className="sm:max-w-[500px]">
    <DialogHeader>
      ...
      <p>The payment is via only the <strong>Commercial Bank of Ethiopia</strong>.</p>
      <p><strong>Account Name:</strong> John Doe</p>
      <p><strong>Account Number:</strong> 10000237653</p>
    </div>
      <DialogDescription>

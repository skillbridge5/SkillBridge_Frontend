    ...
    <div className="min-h-screen font-montserrat bg-white dark:bg-gray-950 transition-colors duration-300 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 lg:px-16">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <form onSubmit={handleSubmit} className="flex-1 shadow-md p-8 rounded-lg bg-white space-y-4">
        ...
        <div className="mt-16">
          <h2 className="text-xl font-semibold text-center mb-4">Find Us On the Map</h2>

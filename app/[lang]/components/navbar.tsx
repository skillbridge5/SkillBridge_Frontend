...
import { ThemeToggle } from "@/app/[lang]/components/theme-toggle";
import { useState } from "react";
import { useRouter, usePathname } from "next/navigation";
import { navbarItems } from "@/app/[lang]/data/navbar-items";
        ...
        >
          <div className="flex justify-between items-center p-4 border-b">
            <div className="flex items-center gap-2">
              <Image
                ...
                height={36}
              />
              <span className="font-bold text-sm sm:text-base">SkillBridge</span>
            </div>
            <Button
              variant="ghost"
              size="icon"
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button size="sm" className="block md:hidden bg-[#2196F3] hover:bg-blue-500 h-9 px-5">
            ...
            <nav className="space-y-4">
              {navbarItems.map((item) => (
                <div key={item.path} className="border-b border-gray-100 dark:border-gray-800">
                  <Link
                    href={item.path}

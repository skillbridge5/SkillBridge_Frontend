          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <h1 className='text-5xl font-bold mb-6 leading-tight'>
                <span style={{ color: "#2196F3" }}>Learn. Build.</span>{" "}
                <span className='text-orange-400'>Launch.</span>
              </h1>
              <p className='text-lg mb-8 text-gray-600 dark:text-gray-300 leading-relaxed'>
                SkillBridge Technologies - Where passionate learners become
                industry-ready developers through hands-on projects, expert
                mentorship, and proven learning methodologies.
              </p>
          ...
          <div className='grid lg:grid-cols-2 gap-16 items-center'>
            <div>
              ...
              <div className='space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed'>
                <p>
                  SkillBridge Technologies was founded in 2020 with a simple yet
                  powerful vision: to bridge the gap between traditional
                  education and the rapidly evolving tech industry. Our
                  founders, experienced software engineers and educators,
                  recognized that many talented individuals were struggling to
                  break into the tech field due to outdated curricula and lack
                  of practical, hands-on experience.
                </p>
                <p>
                  What started as a small coding bootcamp in a shared workspace
                  has grown into a comprehensive school of software development,
                  serving thousands of students worldwide. We believe that
                  everyone deserves access to quality tech education, regardless
                  of their background or previous experience.
                </p>
                <p>
                  Our story is one of passion, dedication, and the unwavering
                  belief that with the right guidance and support, anyone can
                  master the art of software development and build a successful
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto'>
              We exist to democratize tech education and create pathways for
              anyone to build a successful career in software development.
            </p>
          </div>
          <div className='grid lg:grid-cols-2 gap-8'>
            ...
            >
              ...
              <CardContent>
                <p className='text-gray-700 dark:text-gray-300 leading-relaxed mb-6'>
                  To provide world-class, practical software development
                  education that transforms lives. We bridge the gap between
                  learning and doing, ensuring every graduate is not just
                  knowledgeable but job-ready and confident.
                </p>
            ...
            <Card className='border-l-4 border-l-orange-500 shadow-sm h-full dark:bg-gray-800 dark:border-gray-700'>
              ...
              <CardContent>
                <p className='text-gray-700 dark:text-gray-300 leading-relaxed mb-6'>
                  To become the global standard for practical tech education,
                  where talent and dedication matter more than traditional
                  credentials. We envision a world where our graduates lead
                  innovation at every level of the tech industry.
                </p>
                <div className='space-y-3'>
                  <div className='flex items-center text-sm text-gray-600 dark:text-gray-400'>
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 dark:text-gray-400'>
              How we turn beginners into job-ready developers
            </p>
          </div>
          <div className='grid lg:grid-cols-2 gap-16 items-center'>
            <div className='space-y-8'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 dark:text-gray-400'>
                    Start coding from day one. Every concept is immediately
                    applied in hands-on projects that simulate real work
                    environments.
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 dark:text-gray-400'>
                    Create applications that solve actual problems. Your
                    portfolio will showcase real solutions, not just tutorial
                    projects.
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 dark:text-gray-400'>
                    Receive detailed code reviews and personalized guidance from
                    industry professionals who've been where you want to go.
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 dark:text-gray-400'>
                    Leverage our industry connections, interview prep, and job
                    placement support to secure your first developer role.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className='py-20 bg-gray-50 dark:bg-gray-900 -mx-4 lg:-mx-8 px-4 lg:px-8'>
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 dark:text-gray-400'>
              The learning experience that actually prepares you for your first
              dev job
            </p>
          </div>
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <Card className='text-center hover:shadow-lg transition-shadow bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-full flex flex-col min-h-[280px]'>
              ...
              <CardContent className='flex-grow px-6 pb-6'>
                <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                  Our courses are designed by industry professionals and updated
                  regularly to reflect current market demands and emerging
                  technologies. Stay ahead of the curve with cutting-edge skills
            ...
            <Card className='text-center hover:shadow-lg transition-shadow bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-full flex flex-col min-h-[280px]'>
              ...
              <CardContent className='flex-grow px-6 pb-6'>
                <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                  Learn from experienced software engineers and tech leaders who
                  bring real-world experience into the classroom. Get insights
                  from professionals who have worked at top companies and
            ...
            <Card className='text-center hover:shadow-lg transition-shadow bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-full flex flex-col min-h-[280px]'>
              ...
              <CardContent className='flex-grow px-6 pb-6'>
                <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                  Build real projects and gain practical experience through our
                  project-based learning approach and coding challenges. Every
                  lesson includes practical exercises that reinforce your
            ...
            <Card className='text-center hover:shadow-lg transition-shadow bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-full flex flex-col min-h-[280px]'>
              ...
              <CardContent className='flex-grow px-6 pb-6'>
                <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                  ...
                  interview preparation, and job placement assistance. Our
                  dedicated career team works with you from day one to ensure
                  you're ready for your dream job.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='text-center hover:shadow-lg transition-shadow bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-full flex flex-col min-h-[280px]'>
              ...
              <CardContent className='flex-grow px-6 pb-6'>
                <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                  Choose from full-time, part-time, and online options to fit
                  your schedule and learning preferences. Whether you're working
                  full-time or looking for an intensive bootcamp experience, we
            ...
            <Card className='text-center hover:shadow-lg transition-shadow bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-full flex flex-col min-h-[280px]'>
              ...
              <CardContent className='flex-grow px-6 pb-6'>
                <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                  85% job placement rate within 6 months of graduation with
                  competitive starting salaries. Our track record speaks for
                  itself - we're committed to your success and have the results
                  to prove it.
                </p>
              </CardContent>
            </Card>
              ...
              <div className='space-y-6'>
                ...
                >
                  <CardContent className='p-6'>
                    ...
                    <p className='text-gray-600 dark:text-gray-400 mb-4 text-sm leading-relaxed'>
                      Master React, Node.js, databases, and cloud deployment.
                    ...
                    <div className='flex items-center text-xs text-gray-500 dark:text-gray-500'>
                      <Clock
                        ...
                        style={{ color: "oklch(44.6% 0.03 256.802)" }}
                      />
                      <span style={{ color: "oklch(44.6% 0.03 256.802)" }}>
                        16 weeks • Portfolio included
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className='p-6'>
                    ...
                    <p className='text-gray-600 dark:text-gray-400 mb-4 text-sm leading-relaxed'>
                      Python, machine learning, data visualization. Work with
